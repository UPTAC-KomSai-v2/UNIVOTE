    ...
    <div className="voting-page">
      ...
      >
        ...
        <div className="candidateButtons">
          <button onClick={() => {}}>2025 SC ELECTIONS</button>
          <button onClick={() => {navigate('/view-previous-results/?year=2024')}}>2024 SC ELECTIONS</button>
          <button onClick={() => {navigate('/view-previous-results/?year=2023')}}>2023 SC ELECTIONS</button>
        </div>
      </Card>
